...
public class Application {
	...
	public static void main(String[] args) {
  	...
  	server.registerHandler("/rooster/ophalen/docent", roosterController);
  	server.registerHandler("/rooster/ophalen", roosterController);
		
  	server.registerHandler("/les/presentie/ophalen", presentieController);
  	server.registerHandler("/les/presentie/opslaan", presentieController);
  	server.registerHandler("/persoon/presentie/opslaan", presentieController);
